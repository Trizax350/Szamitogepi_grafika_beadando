...
typedef struct {
	...
	Object toilet;
	Object crib;
	Object hanginglight1;
	Object hanginglight2;
	int helpTexture;
	int sourcesTexture;
}World;
...
// Allocate memory for the model. The OBJ file format starts indices from 1. From this reason, the vertices, texture vertices and normals have a blank 0 element.
...
// Read the next index from the string. It also calculate the length of the number and returns in length.
