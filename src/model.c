...
void init_object(Object* object, int x, int y, int z){
	object->position.x = x;
	object->position.y = y;
	object->position.z = z;
...
void init_entities(World* world){
	// Bed
	load_model("models//Bed.obj", &world->bed.model);
	scale_model(&world->bed.model, 3.00, 3.00, 3.00);
	world->bed.texture = load_texture("models//textures//Bed.png");
	init_object(&world->bed, -102, 26, 155);
	
	// Skull
	load_model("models//Skull.obj", &world->skull.model);
	scale_model(&world->skull.model, 0.09, 0.09, 0.09);
	world->skull.texture = load_texture("models//textures//Skull.jpg");
	init_object(&world->skull, 160, -3, -150);
	...
	scale_model(&world->hanginglight1.model, 100.0, 100.0, 100.0);
	world->hanginglight1.texture = load_texture("models//textures//HangingLight.jpg");
	init_object(&world->hanginglight1, 100, 195, 0);
	
	// Hanginglight2
	load_model("models//HangingLight.obj", &world->hanginglight2.model);
	scale_model(&world->hanginglight2.model, 100.0, 100.0, 100.0);
	world->hanginglight2.texture = load_texture("models//textures//HangingLight.jpg");
	init_object(&world->hanginglight2, -100, 195, 0);

	// Room textures
	world->room.ground = load_texture("textures//ground.jpg");
	world->room.back = load_texture("textures//wall_02.jpg");
	world->room.front = load_texture("textures//door.jpg");
	world->room.left = load_texture("textures//wall_01.jpg");
	world->room.right = load_texture("textures//wall_03.jpg");
	world->room.top = load_texture("textures//roof.jpg");

	// Help texture
	world->helpTexture = load_texture("textures//help.png");
	
	// Sources texture
	world->sourcesTexture = load_texture("textures//sources.jpg");
}